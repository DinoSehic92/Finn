...
namespace MuPDFCore.MuPDFRenderer
{
    ...
    {
        /// <summary>
        /// Returns the DPI layout scaling factor for this control.
        /// In Avalonia 12, ILayoutRoot became internal; TopLevel.RenderScaling
        /// (which equals the old LayoutScaling) is the public replacement.
        /// </summary>
        private double GetLayoutScaling()
        {
        ...
        private void ContinueInitialization(int threadCount, int pageNumber, double resolutionMultiplier, bool includeAnnotations, TesseractLanguage ocrLanguage = null)
        {
            ...
            this._Zoom = this.Bounds.Width / DisplayArea.Width * 72 / 96 * GetLayoutScaling();
        ...
        private void RenderFixedCanvas(double resolutionMultiplier)
        {
            ...
            resolutionMultiplier *= GetLayoutScaling();
